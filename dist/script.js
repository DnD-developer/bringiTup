...
document.addEventListener("DOMContentLoaded", () => {
  ...
  sliderIndex.render();
  const sliderShowUp = new _modules_sliders_mini_slider__WEBPACK_IMPORTED_MODULE_1__["MiniSlider"]({
  ...
  sliderShowUp.render();
  const sliderModules = new _modules_sliders_mini_slider__WEBPACK_IMPORTED_MODULE_1__["MiniSlider"]({
  ...
  const sliderFeed = new _modules_sliders_mini_slider__WEBPACK_IMPORTED_MODULE_1__["MiniSlider"]({
...
class MiniSlider extends _slider__WEBPACK_IMPORTED_MODULE_0__["Slider"] {
  constructor(wrapper) {
    super(wrapper);
    this.autoNextSlide;
  }
